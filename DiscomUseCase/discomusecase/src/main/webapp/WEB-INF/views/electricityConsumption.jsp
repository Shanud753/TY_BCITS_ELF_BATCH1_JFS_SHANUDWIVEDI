...
<% MonthlyConsumption consumption = (MonthlyConsumption) request.getAttribute("monthlyConsumption");%>
...
<body>
    ...
    <h3>rr-Number: <%=consumption.getRrNumber() %></h3>
    <h3>Initial Reading: <%=consumption.getInitialReading() %></h3>
    <h3>Final Reading: <%=consumption.getFinalReading() %></h3>
    <h3>Units Consumed: <%=consumption.getUnitsConsumption() %></h3>
